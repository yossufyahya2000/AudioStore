...
class AudioStoreSupabaseUser extends BaseAuthUser {
  AudioStoreSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> audioStoreSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = AudioStoreSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
