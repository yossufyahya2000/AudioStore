...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF0ACF83);
  late Color secondary = const Color(0xFFF6F6F6);
  late Color tertiary = const Color(0xFF7F7F7F);
  late Color alternate = const Color(0xFFBABABA);
  late Color primaryText = const Color(0xFF14181B);
  late Color secondaryText = const Color(0xFFF3F3F3);
  late Color primaryBackground = const Color(0xFFFFFFFF);
  late Color secondaryBackground = const Color(0xFFAEB3BE);
  late Color accent1 = const Color(0xFFFFC120);
